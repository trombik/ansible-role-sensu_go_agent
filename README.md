...
the latest version of `sensu-go`. [The available version of the port](https://www.freshports.org/sysutils/sensu-go/)
does not install `sensu-backend`. You have to fix the port yourself, or install my port from
